...
from ml_project.entity.config_entity import ModelEvaluationConfig, DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig
